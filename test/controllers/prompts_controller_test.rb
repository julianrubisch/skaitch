...
class PromptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prompt" do
    assert_difference("Prompt.count") do
      post prompts_url, params: { prompt: { account_id: @prompt.account_id, prompt_image: @prompt.prompt_image, title: @prompt.title } }
    end
  ...
  test "should update prompt" do
    patch prompt_url(@prompt), params: { prompt: { account_id: @prompt.account_id, prompt_image: @prompt.prompt_image, title: @prompt.title } }
